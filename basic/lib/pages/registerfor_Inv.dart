...
class registerforinv extends StatefulWidget {
  registerforinv({super.key});

  @override
  State<registerforinv> createState() => _registerforinvState();
}

class _registerforinvState extends State<registerforinv> {
  // File? image;
  var selectedRadio;
  var selectedGen;
